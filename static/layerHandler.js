...
//Makes the layers list in the template and adds them to the map, used for the layers that come from the upload function
...
//Used to add new layers generated by the tools.
...
//Updating the dropdown menus in the tools, so it contains the layers that are in the map
...
//Add a single option in the tooldrops, used when we add one layer.
...
//Used to delete the layer when the delete button is clicked.
